...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="cm_mutiperiodview" context="cm_mutiperiodctx" controller="cm_mutiperiodviewController" namespace="com.ump.productquery">
    ...
    <action factoryname="#{plug.factoryname}" id="loadViewPage" refresult="#{plug.refresult}" viewid="com.ump.productquery.Cm_mutiperiodctxExtendController" pk_material="#{plug.pk_material}" pk_factory="#{plug.pk_factory}" action="getMutiPeriodListByPk_materialAndPk_factory" method="UMService.callAction" autoDataBinding="true" lastpageyearmonth="#{plug.yearmonth}" productname="#{plug.productname}"/>
    ...
    <action id="openComparePeriodRef" referenceid="com.ump.productquery.MultiAccperiod_referlist" pk_factory="#{pk_factory}" callback="refcallback" mapping="{&quot;refresult&quot;:&quot;name&quot;}" method="UMView.openReference" refresultstr="#{refresult}"/>
    ...
    <div id="viewPage0" onload="loadViewPage">
        ...
        <listView id="listview0" bindfield="periodproductlist" onuprefersh="refcallback" childIndicator="cm_mutiperiodviewRow" cursorAction="cursorperiodproductlistalias" syncContext="periodproductlist" onItemClick="this.clickListRow()">
