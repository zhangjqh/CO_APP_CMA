...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Productquery_login" context="USERS" controller="cm_loginController" namespace="com.ump.productquery">
    ...
    <action id="loginjs" isDataCollect="true" method="loginjs"/>
    <action id="loginnc" isDataCollect="true" method="loginnc"/>
    <div id="viewPage0" onload="loadconfig">
        ...
        <div id="panel2">
            ...
            <div id="panel4">
                ...
                <input id="textbox1" bindfield="passWord" maxlength="256" placeholder="密码" type="password"/> 
            </div> 
        </div>
        <label id="label4"/>
