...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="cm_productfilter" context="cm_productctx" controller="cm_productfilterController" namespace="com.ump.productquery">
    ...
    <action id="doSearch" count="20" viewid="com.ump.productquery.Cm_productctxExtendController" startline="1" searchfield="#{searchfield}" pk_factory="#{plug.pk_factory}" action="searchProductListByKeyword" callback="this.searchcallback()" isDataCollect="true" method="UMList.getFirstPage"/>
    ...
    <div id="viewPage0">
        ...
        <search id="search0" bindField="searchfield" placeholder="搜索" localstorage="true" onsearch="this.doSearch()"/>
