...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="mutproductdetailview" context="cm_unitcostctx" controller="mutproductdetailviewController" namespace="com.ump.productquery">  
    ...
    <action factoryname="#{factoryname}" id="refreshpage" yearmonth="#{yearmonth}" viewid="com.ump.productquery.Cm_unitcostctxExtendController" pk_org="#{pk_factory}" pk_accperiodmonth="#{pk_accperiodmonth}" pk_material="#{pk_material}" action="getProductDetailInfoByParams" callback="this.handleException()" method="UMService.callAction" autoDataBinding="true" productname="#{productname}"/>  
