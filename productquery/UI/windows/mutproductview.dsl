...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="mutproductview" context="mutproductqueryctx" controller="mutproductviewController" namespace="com.ump.productquery">  
    ...
    <action id="openfactoryRef" current_pk_factory="#{pk_factory}" referenceid="com.ump.productquery.Factory_referlist" callback="getProductListFirstPage" mapping="{&quot;pk_factory&quot;:&quot;pk_factory&quot;,&quot;factoryname&quot;:&quot;factoryname&quot;}" method="UMView.openReference"/>  
    ...
    <action id="loadViewPage" count="20" viewid="com.ump.productquery.MutproductqueryctxExtendController" startline="1" callback="this.setIcon()" action="getDefaultFactoryAndPeriodByCurrtentUser" method="UMService.callAction" autoDataBinding="true"/>  
    ...
    <div id="viewPage0" onload="this.onload()"> 
        <navigatorbar id="navigatorbar0" title="成本+"> 
