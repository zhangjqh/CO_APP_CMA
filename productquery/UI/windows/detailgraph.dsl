...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="detailgraph" context="cm_unitcostctx" controller="detailgraphController" namespace="com.ump.productquery">
    ...
    <action id="loadviewdata" sourcepage="#{plug.sourcepage}" method="loadviewdata"/>
    ...
    <action id="openMutiFactoryView" yearmonth="#{yearmonth}" sourcepage="detailgraph" viewid="com.ump.productquery.Cm_mutfactoryview" pk_accperiodmonth="#{pk_accperiodmonth}" pk_material="#{pk_material}" method="UMView.open" isKeep="true" productname="#{productname}"/>
    <action factoryname="#{factoryname}" id="openMutiPeriodView" yearmonth="#{yearmonth}" sourcepage="detailgraph" viewid="com.ump.productquery.Cm_mutiperiodview" pk_material="#{pk_material}" pk_factory="#{pk_factory}" method="UMView.open" isKeep="true" productname="#{productname}"/>
    ...
    <div id="viewPage0" onload="loadviewdata">
        ...
        <div id="panel11">
            <div id="panel5" onclick="clickIcon">
                <label id="label19" bindfield="concern.currentState">label</label>
                <image id="image0" bindfield="concern.iconsrc" onclick="clickIcon" scaletype="fitcenter" src="concerned.png"/> 
            </div>
            <div id="panel0">
                <label id="label1" bindfield="pk_factory">label</label>
                <label id="label2" bindfield="pk_material">label</label>
                <label id="label3" bindfield="pk_accperiodmonth">label</label> 
            </div>
            <div id="panel1">
                <div id="panel3">
                    <div id="panel12">
                        <label id="label7" bindfield="pk_factory">label</label>
                ...
                <div id="panel4">
                    <div id="panel15">
                        <label id="label8" bindfield="pk_material">label</label>
                        <label id="label5" bindfield="productname"/> 
                    </div>
                    <div id="panel14">
                        <label id="label23"/>
                        <label id="label6" bindfield="yearmonth"/>
                        <label id="label9" bindfield="pk_accperiodmonth">label</label>
